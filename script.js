...
window.examVariantsDatabase = {
    ...
    "easy": {
        1: {
            ...
            part2: [
                ...
                { id: 21, num: "Задание 21 (Всемирная история)", text: "Докажите, что революционные события во Франции конца XVIII века оказали прямое влияние на внутреннюю жизнь как Франции, так и Российской империи.", c: "🔑 <b>Критерии ФИПИ (Задание 21):</b><br>1) <b>Для России:</b> Французская революция напугала Екатерину II, что заставило её ужесточить цензуру и сослать А. Радищева в Сибирь.<br>2) <b>Для Франции:</b> Неудачи революционных армий на внешних фронтах радикализировали массы, привели к падению монархии и казни Людовика XVI." }
            ]
        }
    },

    // СРЕДНИЙ УРОВЕНЬ: Варианты 6-10 (Направлены на 70-90 баллов)
    "medium": {
        6: {
    ...
    // ВЫСОКИЙ УРОВЕНЬ: Варианты 11-15 (90-100 баллов, олимпиадные/экспертные формулировки)
    "hard": {
        11: {
