// ========================================================
//  ГЛОБАЛЬНЫЙ ДВИЖОК ПЛАТФОРМЫ АКАДЕМИЯ ИСТОРИИ (V13.0)
// ========================================================
        ...
        1: {
            ...
            part1: [
                ...
                { 
                    ...
                    col2: ["1) ограничение местничества на время военных действий", "2) financial реформа Г.Я. Сокольникова", "3) объединение Киева и Новгорода под властью одного князя", "4) издание жалованной грамоты дворянству", "5) издание Новоторгового устава", "6) издание Свода законов Российской империи"],
                    a: "3126" 
                },
                { 
                    id: 4, 
                ...
                { 
                    ...
                    type: "standard",
                    num: "Задание 9", 
                    text: "<div class='textbook-map-wrapper'><img class='textbook-map-img' src='images/razin.jpg'></div>Рассмотрите схему. Укажите правителя России в период, когда произошли события, обозначенные на схеме стрелками:", 
                    a: "алексеймихайлович" 
                },
                ...
                { id: 11, type: "standard", num: "Задание 11", text: "Прочтите текст о событиях и укажите название города, дважды пропущенное в тексте:\n«Восставшие окружили Царицын... решили идти на юг, чтобы захватить стоящий в дельте Волги торговый город — ___________. Миновав Чёрный Яр, восставшие вскоре подошли к ___________ и при поддержке бедноты захватили город».", a: "астрахань" },
            ...
            part2: [
                { 
                    id: 13, 
                    num: "Задание 13 (Анализ источника)", 
                    text: "Прочтите отрывок из исторического источника:\n«Прошло уже три года с того времени, когда XXII съезд КПСС принял новую Программу партии... Ни для кого не секрет, что у нас создан и безмерно раздувается своего рода миф о якобы \"великом десятилетии\"... Доказывается, будто за годы, в течение которых товарищ ___________ находится у власти, в хозяйственном развитии страны произошли чудеса...».\n\nУкажите год, когда состоялся Пленум ЦК КПСС. Укажите пропущенную фамилию. Укажите деятеля, занявшего должность Председателя Совета Министров СССР в том же десятилетии.", 
                    c: "🔑 <b>Критерии ФИПИ (№13):</b><br>1) Год — 1964 г.<br>2) Фамилия — Хрущёв.<br>3) Исторический деятель — А.Н. Косыгин." 
                },
                { 
                    id: 14, 
                    num: "Задание 14 (Анализ источника)", 
                    text: "В чём, по утверждению автора доклада, состоит правда о развитии экономики СССР в ходе «великого десятилетия»? Как автор охарактеризовал профессиональные качества людей, подготовивших Программу КПСС? Как автор характеризует сроки, установленные в Программе?", 
                    c: "🔑 <b>Критерии ФИПИ (№14):</b><br>1) Экономика по ряду важнейших направлений резко ухудшила свои показатели.<br>2) Разработчики — «знающие экономику в теоретическом плане, но очень далёкие от жизни».<br>3) Сроки характеризуются как нереальные." 
                },
                { 
                    id: 15, 
                    num: "Задание 15 (Иллюстративный практикум)", 
                    text: "<div style='text-align:center; margin:15px 0;'><img src='images/medal_northern_war.jpg' style='max-width:420px; width:100%; border-radius:6px; box-shadow:var(--shadow-md);'><br></div>Рассмотрите памятную медаль, на которой заретушировано имя исторического деятеля. Укажите князя (политического лидера), имя и фамилия которого скрыты. Используя изображение, приведите одно любое обоснование.", 
                    c: "🔑 <b>Критерии ФИПИ (№15):</b> Д.М. Пожарский. Обоснование: на медали назван Кузьма Минин и Нижний Новгород, где формировалось Второе народное ополчение, военным руководителем которого и был приглашен князь Пожарский." 
                },
                { 
                    id: 16, 
                    num: "Задание 16 (Историческая архитектура)", 
                    text: "<div style='text-align:center; margin:15px 0;'><img src='images/architecture_options.jpg' style='max-width:550px; width:100%; border-radius:6px; box-shadow:var(--shadow-md);'><br></div>Какой из представленных памятников архитектуры был возведён ПОСЛЕ событий, отображённых на медали (после Смутного времени)? В ответе запишите цифру и укажите город, где он находится.", 
                    c: "🔑 <b>Критерии ФИПИ (№16):</b> Цифра — 4. Город — Санкт-Петербург (на картинке под номером 4 представлен Исаакиевский собор, возведенный в XIX в.)." 
                },
                { 
                    id: 17, 
                    num: "Задание 17 (Великая Отечественная война)", 
                    text: "Прочтите фрагмент: «30 января пленные показали, что штаб Паулюса находится в подвале универмага... К 6 часам утра отряд окружил танками универмаг и предложил штабу 6-й армии сдаться...». Укажите год событий. Укажите командующего Юго-Западным фронтом в этот период. Какое отрицательное последствие согласно текстам имела для гитлеровцев катастрофа под Сталинградом?", 
                    c: "🔑 <b>Критерии ФИПИ (№17):</b> 1) Год — 1943 г. 2) Командующий — Н.Ф. Ватутин. 3) Последствие: отнимала у гитлеровцев всякую надежду на дальнейшие наступательные действия на юге." 
                },
                { 
                    id: 18, 
                    num: "Задание 18 (Причинно-следственные связи)", 
                    text: "В XII в. начался процесс политической раздробленности Руси, но на протяжении XIII–XV вв. возникали предпосылки объединения. Укажите:\nа) предпосылку объединения, связанную с внешнеполитическим фактором;\nб) экономическую причину;\nв) причину, связанную с позицией Русской Православной Церкви.", 
                    c: "🔑 <b>Критерии ФИПИ (№18):</b><br>а) Необходимость борьбы с ордынским владычеством и внешней угрозой.<br>б) Рост производительности сельского хозяйства, ремесла и развитие товарообмена между землями.<br>в) Стремление Церкви сохранить единую церковную структуру и поддержка объединяющих московских князей." 
                },
                { 
                    id: 19, 
                    num: "Задание 19 (Исторический термин)", 
                    text: "Используя знания по истории России, раскройте смысл понятия «Восточный вопрос». Приведите один исторический факт, конкретизирующий данное понятие применительно к истории России.", 
                    c: "🔑 <b>Критерии ФИПИ (№19):</b> Смысл: условное обозначение комплекса международных противоречий конца XVIII — начала XX в., связанных со слаблением Османской империи и борьбой европейских держав за раздел её владений. Факт: Обострение восточного вопроса привело к Крымской войне." 
                },
                { 
                    id: 20, 
                    num: "Задание 20 (Сравнительный тезис)", 
                    text: "Запишите один любой тезис (обобщённое оценочное суждение), содержащий информацию о сходстве внутренней политики Екатерины II и Александра III по какому-либо признаку. Приведите два исторических обоснования этого тезиса.", 
                    c: "🔑 <b>Критерии ФИПИ (№20):</b> Тезис: внутренняя политика обоих правителей была направлена на укрепление социально-экономического и сословного положения дворянства. Обоснования: 1) Екатерина II издала Жалованную грамоту дворянству, закрепившую их сословные права. 2) Александр III учредил Государственный дворянский земельный банк для финансовой поддержки потомственных дворян." 
                },
                { 
                    id: 21, 
                    num: "Задание 21 (Всемирная история)", 
                    text: "Приведите аргументы в подтверждение точки зрения, что в России в конце 1910-х – начале 1920-х гг. и в Китае в 1940-х гг. в ходе гражданских войн государства Запада оказывали поддержку тем сторонам конфликтов, которые в итоге потерпели поражение: один аргумент для России и один для Китая.", 
                    c: "🔑 <b>Критерии ФИПИ (№21):</b><br>1) Для России: в ходе Гражданской войны страны Антанты оказывали материальную и интервенционную поддержку Белому движению, но белые проиграли большевикам.<br>2) Для Китая: во второй половине 1940-х гг. США снабжали оружием и техникой армию Гоминьдана (Чан Кайши), однако победу одержала Коммунистическая партия Китая." 
                }
            ]
        }
    }
...
// Глубокое клонирование вариантов для защиты от падения map во 2-й части
