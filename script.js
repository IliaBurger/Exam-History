// ========================================================
//  ГЛОБАЛЬНЫЙ ДВИЖОК ПЛАТФОРМЫ АКАДЕМИЯ ИСТОРИИ (V14.1)
// ========================================================
        ...
        1: {
            ...
            part1: [
                ...
                { 
                    ...
                    col1: ["А) деятельность Посольского приказа в период правления Алексея Михайловича", "Б) Специальная военная операция (СВО)", "В) деятельность Верховной распорядительной комиссии", "Г) bitva за Берлин"],
