// ========================================================
//  ГЛОБАЛЬНЫЙ ДВИЖОК ПЛАТФОРМЫ АКАДЕМИЯ ИСТОРИИ (V11.6)
// ========================================================
        ...
        1: {
            ...
            part1: [
                ...
                { 
                    ...
                    type: "matching",
                    num: "Задание 3", 
                    text: "Установите соответствие между процессами (явлениями, событиями) и фактами, относящимися к этим процессам (явлениям, событиям): к каждой позиции первого столбца подберите соответствующую позицию из второго столбца.",
                ...
                { 
                    ...
                    rows: [
                        ["Донецк", "(А)", "2020-е гг."],
                        ["(Б)", "Строительство Трассибирской магистрали", "(В)"],
                        ["Деревня Андрусово", "Подписание перемирия между Россией и Речью Посполитой", "(Г)"],
                        ["(Д)", "(Е)", "1910-е гг."]
                    ],
                    list: "<b>Пропущенные элементы:</b>\n1) Petrograd, 2) Севастополь, 3) 1890-е гг., 4) Владивосток, 5) 1660-е гг., 6) ввод в эксплуатацию первой в мире АЭС, 7) деятельность Всероссийского Учредительного собрания, 8) 1790-е гг., 9) вхождение в состав Российской Федерации.",
                    a: "943517" 
                },
                { 
                    id: 5, 
                ...
                { id: 11, type: "standard", num: "Задание 11", text: "Прочтите текст о событиях, отражённых на схеме, и, используя схему, укажите название города, дважды пропущенное в тексте:\n«Восставшие окружили Царицын, но город не сдавался... В Царицыне состоялся военный совет, на котором решили идти на юг, чтобы захватить стоящий в дельте Волги торговый город — ___________. Миновав Чёрный Яр, восставшие вскоре подошли к ___________ и при поддержке городской бедноты захватили город».", a: "астрахань" },
                { id: 12, type: "standard", num: "Задание 12", text: "Какие суждения, относящиеся к схеме, являются верными? Запишите цифры, под которыми они указаны.\n1) Флажком на схеме обозначено место казни предводителя восстания.\n2) На схеме отмечена и подписана река, переименованная сразу после подавления восстания.\n3) В подавлении восстания принимал участие А.В. Суворов.\n4) Предводитель восстания называл себя воеводой царя Дмитрия Ивановича.\n5) Саратов находился на территории, охваченной восстанием.\n6) В городе под цифрой «1» (Нижний Новгород) было сформировано Второе народное ополчение.", a: "56" }
            ],
            part2: [
                { id: 13, num: "Задание 13", text: "Прочтите отрывок из исторического источника (доклад к Пленуму ЦК КПСС). Укажите год Пленума, пропущенную в тексте фамилию лидера (Хрущёв) и Председателя Совета Министров СССР в этом десятилетии.", c: "🔑 <b>Критерии ФИПИ (№13):</b><br>1) Год — 1964 г.<br>2) Фамилия — Хрущёв.<br>3) Исторический деятель — А.Н. Косыгин." },
                { id: 14, num: "Задание 14", text: "В чём, по утверждению автора доклада, состоит правда о развитии экономики СССР в ходе «великого десятилетия»? Как автор охарактеризовал профессиональные качества людей, которые подготовили Программу КПСС? Как автор характеризует сроки, установленные в Программе КПСС для достижения ряда показателей?", c: "🔑 <b>Критерии ФИПИ (№14):</b><br>1) Экономика по ряду важнейших направлений резко ухудшила свои показатели.<br>2) «Знающие экономику в теоретическом плане, но очень далёкие от жизни».<br>3) Сроки нереальные." },
                { id: 15, num: "Задание 15", text: "<div style='text-align:center; margin:15px 0;'><img src='images/medal_northern_war.jpg' style='max-width:400px; width:100%; border-radius:8px;'><br></div>Укажите князя, имя и фамилия которого заретушированы на памятной медали. Используя изображение, приведите одно любое обоснование Вашего ответа.", c: "🔑 <b>Критерии ФИПИ (№15):</b> Д.М. Пожарский. Обоснование: на медали назван К. Минин и Нижний Новгород, где было создано Второе ополчение во главе с военным руководителем Д.М. Пожарским." },
                { id: 16, num: "Задание 16", text: "<div style='text-align:center; margin:15px 0;'><img src='images/architecture_options.jpg' style='max-width:550px; width:100%; border-radius:8px;'><br></div>Какой из представленных памятников архитектуры был возведён после событий, отображённых на медали? В ответе запишите цифру, которой обозначен этот памятник. Укажите название города, где находится этот памятник архитектуры.", c: "🔑 <b>Критерии ФИПИ (№16):</b> Цифра — 4 (Исаакиевский собор). Город — Санкт-Петербург." },
                { id: 17, num: "Задание 17", text: "Прочтите отрывки из воспоминаний (Сталинградская битва). Укажите год, пропущенный в одном из отрывков. Укажите командующего Юго-Западным фронтом в период битвы. Какое отрицательное последствие с военной точки зрения имела для гитлеровцев катастрофа под Сталинградом?", c: "🔑 <b>Критерии ФИПИ (№17):</b> 1) Год — 1943 г. 2) Командующий — Н.Ф. Ватутин. 3) Последствие: отнимала у гитлеровцев всякую надежду на дальнейшие наступательные действия на юге." },
                { id: 18, num: "Задание 18", text: "В XII в. начался процесс политической раздробленности Руси, но на протяжении XIII–XV вв. возникали причины (предпосылки) объединения русских земель в единое государство. Укажите:\nа) причину (предпосылку) объединения, связанную с внешнеполитическим фактором;\nб) экономическую причину (предпосылку);\nв) причину (предпосылку), связанную с позицией Русской Православной Церкви.", c: "🔑 <b>Критерии ФИПИ (№18):</b><br>а) Необходимость свержения ордынского ига.<br>б) Развитие экономических связей и товарообмена между княжествами.<br>в) Стремление Церкви упрочить единую церковную структуру." },
                { id: 19, num: "Задание 19", text: "Используя знания по истории России, раскройте смысл понятия «восточный вопрос». Приведите один исторический факт, конкретизирующий данное понятие применительно к истории России.", c: "🔑 <b>Критерии ФИПИ (№19):</b> Смысл: комплекс международных противоречий конца XVIII — начала XX в., связанных с упадком Османской империи и борьбой держав за её владения. Факт: обострение восточного вопроса привело к Крымской войне." },
                { id: 20, num: "Задание 20", text: "Запишите один любой тезис (обобщённое оценочное суждение), содержащий информацию о сходстве внутренней политики Екатерины ІІ и Александра ІІІ по какому(-им)-либо признаку (-ам). Приведите два обоснования этого тезиса.", c: "🔑 <b>Критерии ФИПИ (№20):</b> Тезис: оба монарха укрепляли сословные права и привилегии дворянства. Обоснование: Екатерина II издала Жалованную грамоту дворянству; Александр III учредил Государственный дворянский земельный банк." },
                { id: 21, num: "Задание 21", text: "Используя исторические знания, приведите аргументы в подтверждение точки зрения, что в России в конце 1910-х начале 1920-х гг. и в Китае в 1940-х гг. в ходе вооружённых противостояний внутри этих стран государства Запада оказывали поддержку тем сторонам конфликтов, которые в итоге потерпели поражение: один аргумент для России и один для Китая.", c: "🔑 <b>Критерии ФИПИ (№21):</b><br>1) Для России: страны Антанты оказывали интервенционную поддержку Белому движению, но белые проиграли большевикам.<br>2) Для Китая: США активно снабжали техникой силы Гоминьдана (Чан Кайши), но победу одержала КПК Мао Цзэдуна." }
            ]
        }
    },
    "medium": {
...
function initTrainerQuiz() {
    globalLoadedQuestions = {
        ...
        "world_new": { "easy": [{ "q": "В каком году началась Французская运行 революция?", "a": "1789" }] },
