// ========================================================
//  ГЛОБАЛЬНЫЙ АВТОНОМНЫЙ ДВИЖОК ПЛАТФОРМЫ (ВЕРСИЯ 5.1)
// ========================================================

// 1. ПОЛНАЯ БАЗА ДАННЫХ ВАРИАНТОВ ДЛЯ СИМУЛЯТОРА КИМ
window.examVariantsDatabase = {
    "easy": {
        1: {
            ...
            part2: [
                { id: 13, num: "Задание 13", text: "Прочтите летопись: 'Придоша языци незнаеми... на землю Половецкую...'. Укажите битву и век.", c: "🔑 <b>Критерии ФИПИ:</b> 1) Битва на реке Калке. 2) XIII век." },
                { id: 18, num: "Задание 18", text: "Укажите три последствия восстания в Киеве в 1113 году.", c: "🔑 <b>Критерии ФИПИ:</b> 1) Призвание Мономаха; 2) Издание «Устава»; 3) Защита закупов." }
            ]
        }
    },
    "medium": {
        6: {
            ...
            part1: [
                { id: 1, num: "Задание 1 (Хронология)", text: "Установите соответствие:\nА) Стояние на Угре\nБ) Медный бунт в Москве\nВ) Манифест о вольности дворянства\nГ) Объявление США войны Германии\n\nГоды: 1) 1480, 2) 1649, 3) 1662, 4) 1762, 5) 1914, 6) 1917.\n\nВведите цифры:", a: "1346" },
                { id: 6, num: "Задание 6", text: "Прочтите отрывок: «...Ныне присягаем малолетнему государю нашему Петру Алексеевичу...». В каком году происходили события?", a: "1682" }
            ],
            part2: [
                { id: 18, num: "Задание 18", text: "Назовите три причины победы Москвы в борьбе за лидерство в XIV веке.", c: "🔑 <b>Критерии ФИПИ:</b> Поддержка церкви, география, гибкая политика князей." }
            ]
        }
    },
    "hard": {
        11: {
            title: "Вариант №11 (Олимпиадный уровень — ФИПИ)",
            part1: [
                { id: 1, num: "Задание 1 (Хронология)", text: "Установите соответствие:\nА) Битва на Салнице\nБ) Медвежьегорская операция\nВ) Деулинское перемирие\nГ) Нерчинский договор\n\nГоды: 1) 1111, 2) 1618, 3) 1689, 4) 1944, 5) 1410, 6) 1223.\n\nВведите цифры:", a: "1234" },
                { id: 6, num: "Задание 6", text: "Как на Руси назывался тип грамот, даровавших судебный и налоговый иммунитет монастырям?", a: "тарханнаяграмота" }
            ],
            part2: [
                { id: 21, num: "Задание 21", text: "Докажите влияние Французской революции конца XVIII в. на внутреннюю политику России и Франции.", c: "🔑 <b>Критерии ФИПИ:</b> Репрессии против Радищева в России; падение Людовика XVI во Франции." }
            ]
        }
    }
};
...
// ========================================================
// 4. ПОЛНОСТЬЮ АВТОНОМНЫЙ ОНЛАЙН-ТРЕНАЖЁР (БЕЗ ЗАВИСИМОСТИ ОТ FETCH)
// ========================================================
...
function initTrainerQuiz() {
    // Вшиваем вопросы прямо в код скрипта. Теперь они подгрузятся мгновенно!
    globalLoadedQuestions = {
        ...
        "world": {
            ...
            "medium": [
                { "q": "В каком году произошла Великая французская буржуазная революция?", "a": "1789" },
...
function renderSingleQuestion() {
    ...
    // Делаем карточку вопроса видимой на экране!
