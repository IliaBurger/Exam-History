// ========================================================
//  ГЛОБАЛЬНЫЙ ДВИЖОК ПЛАТФОРМЫ АКАДЕМИЯ ИСТОРИИ (V11.2)
// ========================================================
...
window.examVariantsDatabase = {
    "easy": {
        1: {
            ...
            part2: [
                ...
                { id: 18, num: "Задание 18", text: "Назовите три последствия Соборного уложения 1649 г.", c: "🔑 Бессрочный сыск беглых крестьян, ликвидация белых слобод." },
                { id: 19, num: "Задание 19", text: "Раскройте смысл понятия «Поместье».", c: "🔑 Земельное владение за службу без права продажи." },
                ...
                { id: 21, num: "Задание 21", text: "Докажите дестабилизацию от Раскола в России и Реформации в Германии.", c: "🔑 Религиозные войны в Германии; раскол общества и Соловецкое восстание старообрядцев на Руси." }
            ]
        }
    },
    "medium": {
        6: {
            ...
            part1: [
                { id: 1, num: "Задание 1 (Хронология)", text: "Установите соответствие:\nА) Сенат Петра I, Б) Смоленская война, В) Манифест о трехдневной барщине, Г) Реформа Столыпина.\nГоды: 1) 1632, 2) 1711, 3) 1797, 4) 1906.", a: "2135" }
            ],
            part2: [
    ...
    "hard": {
        11: {
            ...
            part1: [
                { id: 6, num: "Задание 6", text: "Грамота: «...мытники наши в монастырскую вотчину не вступаются...». Как называлась такая грамота?", a: "тарханнаяграмота" }
            ],
            part2: [
                { id: 21, num: "Задание 21", text: "Докажите деструктивный вклад опричнины.", c: "🔑 Хозяйственный кризис — Поруха пашни 1570-1580-х гг., запустение деревень." }
            ]
        }
    }
};
...
// БАНК ДАННЫХ ДЛЯ ОНЛАЙН-ТРЕНАЖЕРА (ВКЛЮЧАЯ НОВЫЙ БЛОК 1136-1510)
    ...
    globalLoadedQuestions = {
        ...
        "rus_ancient": {
            "easy": [
                ...
                { "q": "В каком году княгиня Ольга приняла христианство (по летописи)?", "a": "957" },
                ...
                { "q": "В каком году погиб князь Святослав у днепровских порогов?", "a": "972" },
                { "q": "В каком году произошло Крещение Руси (условная дата)?", "a": "988" },
                { "q": "В каком городе принял крещение Владимир Святой (Корсунь)?", "a": "корсунь" },
                { "q": "В каком году Ярослав Мудрый разбил печенегов под Киевом?", "a": "1036" },
                ...
                { "q": "В каком году состоялся Любечский съезд князей?", "a": "1097" }
            ],
            "medium": [
                ...
                { "q": "Каковы были реальные политические причины объединения Новгорода и Киева Олегом? Назовите торговый путь:", "a": "изварягвгреки" },
                { "q": "В чем заключалась реформа полюдья княгиней Ольгой? Назовите фиксированные пункты сбора налогов:", "a": "погосты" },
                { "q": "Каковы были последствия разгрома Хазарского каганата для Восточной Европы? Нашествие каких новых кочевников это спровоцировало?", "a": "печенеги" },
                { "q": "Каковы причины первой усобицы между сыновьями Святослава? Кто из братьев в итоге занял Киевский престол?", "a": "владимир" },
                { "q": "Проанализируйте «языческую реформу» Владимира Святого 980 г. Какого бога он поставил во главе пантеона?", "a": "перун" },
                { "q": "Почему в «Правде Ярославичей» была полностью отменена кровная месть? Каким денежным штрафом её заменили?", "a": "вира" },
                { "q": "Каков был правовой статус закупа по «Уставу Владимира Мономаха»? Как называлась ссуда?", "a": "купа" },
                { "q": "В каком городе в 1119 году был построен знаменитый каменный Георгиевский собор Юрьева монастыря?", "a": "новгород" }
            ],
            "hard": [
                { "q": "Разберите гипотезу о «Русском каганате» в Среднем Поднепровье. К какому веку относятся первые упоминания титула 'хакан' у русов в Бертинских анналах? (Ответ римской цифрой)", "a": "IX" },
                ...
                { "q": "Как называлась высшая мера наказания по Русской Правде, каравшая за конокрадство и разбой полной конфискацией имущества?", "a": "потокиразграбление" },
        ...
        // --- 💥 НОВАЯ ЭПОХА: РАЗДРОБЛЕННОСТЬ И РУСЬ (1136-1510 гг.) ---
        "rus_horde": {
            "easy": [
                { "q": "В каком году в Новгороде произошло восстание, приведшее к изгнанию князя Всеволода Мстиславича и установлению боярской республики?", "a": "1136" },
                { "q": "В каком году войска хана Батыя взяли и разорили Рязань, положив начало нашествию на Северо-Восточную Русь?", "a": "1237" },
                { "q": "В каком году произошло Ледовое побоище (битва на Чудском озеро) под руководством Александра Невского?", "a": "1242" },
                { "q": "В каком году объединенное русское войско под руководством Дмитрия Донского разгромило Мамая на Куликовом поле?", "a": "1380" },
                { "q": "В каком году произошло знаменитое Стояние на реке Угре, завершившееся падением ордынского ига?", "a": "1480" },
                { "q": "В каком году великий князь Иван III Васильевич ликвидировал независимость Новгородской республики и вывез вечевой колокол?", "a": "1478" },
                { "q": "В каком году Псковская земля была официально включена в состав единого Русского государства? (Введите цифрами)", "a": "1510" }
            ],
            "medium": [
                { "q": "Как назывался первый письменный общерусский судебный кодекс, изданный Иваном III в 1497 году?", "a": "судебник" },
                { "q": "Какое кодовое название носила ордынская грамота, дававшая русским князьям право на великое княжение?", "a": "ярлык" },
                { "q": "Какое название в истории получило затяжное соперничество Москвы и Твери за лидерство в XIV веке?\nНазовите тверского князя, разбитого Иваном Калитой в 1327 году:", "a": "александрмихайлович" },
                { "q": "Назовите реку, на которой в 1378 году русское войско нанесло первое крупное поражение карательному отряду мурзы Бегича:", "a": "вожа" },
                { "q": "В правление какого московского князя было ликвидировано самостоятельное удельное Серпуховское княжество?", "a": "василийтретий" }
            ],
            "hard": [
                { "q": "В каком году произошло первое трагическое столкновение коалиции русских князей и половцев с монголами на реке Калке?", "a": "1223" },
                { "q": "Назовите тверского князя, подписавшего в 1485 году тайный союз с польским королем Казимиром, что привело к штурму и падению Твери Ивана III:", "a": "михаилборисович" },
                { "q": "Как назывался особый налог (сбор), введенный Иваном III для содержания наместников на местах до проведения губной реформы?", "a": "кормление" },
                { "q": "Назовите имя преподобного монаха, основателя Троице-Сергиева монастыря, благословившего Дмитрия Донского на Куликовскую битву:", "a": "сергийрадонежский" }
            ]
        },
        // --- ПОСЛЕДУЮЩИЕ ПЕРИОДЫ ---
