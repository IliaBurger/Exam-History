...
window.examVariantsDatabase = {
    ...
    "medium": {
        6: {
            ...
            part2: [
                { id: 18, num: "Задание 18", text: "Назовите три причины победы Москвы в борьбе за лидерство в XIV веке.", c: "🔑 Поддержка церкви, перенос кафеды митрополита, мудрая политика Калиты с Ордой." }
            ]
        }
    },
    "hard": {
...
// Железный глубокий дубликатор (Защита от падения map во 2-й части)
...
// РАСШИРЕННЫЙ БАНК ДАННЫХ ДЛЯ ТРЕНАЖЕРА (ИСПРАВЛЕННЫ ОПЕЧАТКИ)
    ...
    globalLoadedQuestions = {
        "rus_ancient": {
            ...
            "hard": [
                ...
                { "q": "Назовите реку, на которой в 1111 г. Владимир Мономах нанес поражение половцам.", "a": "салница" }
            ]
        },
        "rus_horde": {
            "easy": [
        ...
        "rus_ussr": {
            ...
            "hard": [
                { "q": "Какое название в советской историографии получила наступательная операция 1944 г. в Карелии?", "a": "пятысталинскийудар" }
            ]
        },
        "rus_modern": {
            "easy": [{ "q": "В каком году Крым официально вернулся в состав РФ?", "a": "2014" }],
            "medium": [{ "q": "В каком году в РФ была проведена масштабная Конституционная реформа?", "a": "2020" }],
            "hard": [{ "q": "В каком году произошел дефолт технического долга ГКО?", "a": "1998" }]
        },
        "world_ancient": {
            "easy": [{ "q": "В каком веке произошло падение Западной Римской империи? (Римской цифрой)", "a": "V" }],
            "medium": [{ "q": "Имя древнеегипетского фараона, построившего самую большую пирамиду в Гизе.", "a": "хеопс" }],
            "hard": [{ "q": "В каком году произошло великий раскол единой христианской церкви?", "a": "1054" }]
        },
        "world_middle": {
            "easy": [{ "q": "В каком году завершилась Столетняя война?", "a": "1453" }],
            "medium": [{ "q": "Назовите имя французской героини, сожженной на костре в ходе Столетней войны.", "a": "жаннадарк" }],
            "hard": [{ "q": "Назовите серию религиозно-военных походов европейских рыцарей на Ближний Восток.", "a": "крестовыепоходы" }]
        },
        "world_new": {
            "easy": [{ "q": "В каком году началась Великая французская буржуазная революция?", "a": "1789" }],
            "medium": [{ "q": "Назовите имя немецкого монаха, вывесившего 95 тезисов в 1517 г.", "a": "мартинлютер" }],
            "hard": [{ "q": "В каком году был подписан Вестфальский мир, завершивший Тридцатилетнюю войну?", "a": "1648" }]
        },
        "world_recent": {
            "easy": [{ "q": "В каком году началась Первая мировая война?", "a": "1914" }],
            "medium": [{ "q": "Как называлась экономическая депрессия, начавшаяся в США в 1929 году?", "a": "великаядепрессия" }],
            "hard": [{ "q": "В каком году был создан Североатлантический альянс (НАТО)?", "a": "1949" }]
        }
    };
...
function renderSingleQuestion() {
    ...
    document.getElementById('main-quiz-card').classList.remove('state-correct', 'state-indigo');
